...
#include "IKMWorldMapModuleInterface.h"

class FKMWorldMapEditor : public IKMWorldMapModuleInterface
{
public:
	...
	*/
	static inline FKMWorldMapEditor& Get()
	{
		return FModuleManager::LoadModuleChecked< FKMWorldMapEditor >("ToolExampleEditor");
	}
